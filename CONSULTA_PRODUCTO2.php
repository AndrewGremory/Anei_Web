...
{ 
		...
		$resultados = mysqli_query($conexion," SELECT * FROM producto WHERE codigo LIKE '%$mi_busqueda%' or nombre LIKE '%$mi_busqueda%' or tipo LIKE '%$mi_busqueda%'
        or politica LIKE '%$mi_busqueda%'");
        echo'
        <table id="example" class="display" style="width:100%">
        <thead>
            <tr>
